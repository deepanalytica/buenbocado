...
export default function CarritoPage() {
    ...
    return (
        <>
            ...
            {/* Persistent Mobile Checkout Footer */}
            <div className="fixed bottom-0 inset-x-0 bg-white/80 backdrop-blur-2xl border-t border-gray-100 p-6 pb-safe-area lg:hidden z-50 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
                <div className="flex items-center justify-between gap-6">
                    <div className="flex flex-col min-w-max">
                        <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Total a pagar</span>
                        <span className="text-2xl font-black text-green-brand tracking-tighter">
                            {formatPrice(total)}
                        </span>
                    </div>
                    <Link href="/checkout" className="btn btn-primary px-10 flex-grow shadow-xl shadow-green-brand/10 text-center font-black uppercase tracking-widest text-xs">
                        Pagar Ahora
                    </Link>
                </div>
            </div>
